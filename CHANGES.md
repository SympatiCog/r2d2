...
This hotfix addresses test suite failures by implementing the following minimal changes to r2d2_base.py:
...
3. **compute_r2d2**: Changed in-place operations to support mock objects in tests
4. **compute_r2d2**: Added explicit template_dims parameter passing to roi_max_vals
5. **compute_r2d2**: Changed exception handling to raise controlled RuntimeError
